...
class Profile(models.Model):
    ...
    last_name = models.CharField(max_length=5, blank=True, default ='')
    likes_me = models.ManyToManyField(User, blank=True,related_name= 'likes_me')
    liked_mangoes = models.ManyToManyField(User, blank=True,related_name= 'i_like')
    ...
    occupation = models.CharField(max_length=5, blank=True, default ='')
    ...
    location = models.CharField(max_length=5, blank=True, default ='')
    ...
    interests = models.CharField(max_length=200,default='',choices=(('science','science'),('art','art'),('photography','photography')))
